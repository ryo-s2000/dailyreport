...
@section('content')
    ...
    <script>
        ...
        const showTraderForm = (button_this) => {
            $(button_this).parent().append(`<select class="department"><option value="">部署を選択してください</option><option value="1">住宅部</option><option value="2">土木部</option><option value="3">特殊建築部</option><option value="4">農業施設部</option></select>`);
